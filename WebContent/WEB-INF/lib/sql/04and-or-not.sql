...
-- Customers 테이블에서 Country가 Germany이고, City가 Berlin인 행의 CustomerName 조회
...
-- Custoemrs 테이블에서 Country가 Germany 이거나 Country가 Spain 인 행 조회
SELECT * FROM Customers WHERE Country='Germany' OR Country='Spain';

-- NOT : 조건에 해당하지 않는 것
SELECT * FROM Customers WHERE NOT Country = 'UK';

-- Customers 테이블에서 Country 가 Germany가 아닌 행 조회(NOT 키워드 사용)
