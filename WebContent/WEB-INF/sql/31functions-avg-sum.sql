...
-- avg
SELECT AVG(Price) FROM Products;	-- 28.866364 -> 28.496282 -> 28.135570
...
-- 연습 1 : SubQuery 사용해서 평균값 이하인 상품 목록
SELECT * FROM Products
WHERE Price <= (SELECT AVG(Price) FROM Products);	-- <= 서브쿼리는 단일 (1row)

-- 연습 2 : SubQuery 사용해서 평균값 이상인 상품 목록
SELECT * FROM Products
WHERE Price >= (SELECT AVG(Price) FROM Products);

-- 연습 3 : 1996-07-08 에 주문한 상품의 총 수량 (Quantity)
