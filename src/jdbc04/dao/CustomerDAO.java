...
public class CustomerDAO {
	...
	public List<Customer> getCustomerListByCountry(Connection con, String country) {
		...
		String sql = "SELECT CustomerID, CustomerName, ContactName, Address, City,"
				+ " PostalCode, Country FROM Customers WHERE Country = ?";
	...
	public boolean update(Connection con, Customer customer) {
		String sql = "UPDATE Customers " + "SET CustomerName=?, ContactName=?, Address=?, City=?, PostalCode=?, Country=? "
				+ " WHERE CustomerID = ?";
	...
	public Customer selectById(Connection con, int customerID) {
		String sql = "SELECT CustomerName, ContactName, Address, City, PostalCode, Country "
